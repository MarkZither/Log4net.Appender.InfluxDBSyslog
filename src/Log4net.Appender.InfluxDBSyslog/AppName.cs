...
namespace Log4net.Appender.InfluxDBSyslog
{
    ...
    public class AppName
    {
        ...
        /// </summary>
        /// <remarks>
        /// Default constructor for the AppName class.
        /// </remarks>
        public AppName()
        {
    ...
    public class ConvertStringToAppName : IConvertFrom
    {
        ...
        object IConvertFrom.ConvertFrom(object source)
        {
            ...
            throw ConversionNotSupportedException.Create(typeof(AppName), source);
        }
    }
}